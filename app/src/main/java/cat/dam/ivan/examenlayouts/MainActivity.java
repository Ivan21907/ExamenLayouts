package cat.dam.ivan.examenlayouts;
...
public class MainActivity extends AppCompatActivity {
     ...
     */
        ...
        View child = getLayoutInflater().inflate(R.layout.exercici1, null);
        ...
        btn_lyt2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                fl_content.removeAllViews();
                View child = getLayoutInflater().inflate(R.layout.exercici2, null);
                fl_content.addView(child);
            }
        });
        btn_lyt3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                fl_content.removeAllViews();
                View child = getLayoutInflater().inflate(R.layout.exercici3, null);
                fl_content.addView(child);
            }
        });
    }
